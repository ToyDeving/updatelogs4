...
module.exports = {
	...
	list: {
		...
		"SUGGESTION_FROM_TITLE": {
			string: "New Update Log from {{user}}",
		...
		"SUGGESTION_CHANGE_REVIEW_EMBED": {
			string: "A change was processed on this update",
