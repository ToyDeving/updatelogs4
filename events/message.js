...
module.exports = async (Discord, client, message) => {
	...
	commandLog(`🔧 ${message.author.tag} (\`${message.author.id}\`) ran command in ${message.guild ? `the **${message.channel.name}** (\`${message.channel.id}\`) channel of **${message.guild.name}** (\`${message.guild.id}\`)` : "DMs" }`, message);
